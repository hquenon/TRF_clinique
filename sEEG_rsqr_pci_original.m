...
% % Patient worspace
out_path = 'C:\Users\nadege\Desktop\camille\seeg\agnes\Med_Eli';
% % SonsPurs file 
%SonsPurs_path =
...
predictive_gain =  sorciere_pred.r2*100 - sorciere_acou.r2*100 ;
...
for i = 1:numel(channels)
    ...
    gain = sorciere_pred.r2(i) - sorciere_acou.r2(i)
...
predictive_gain = pianos_pred.r2*100 - pianos_acou.r2*100;
predictive_gain(predictive_gain < 0) = 0;
...
for i = 1:numel(channels)
    ...
    % if gain > 0 : save kernel, else : keep zeros
    gain = pianos_pred.r2(i) - pianos_acou.r2(i)
