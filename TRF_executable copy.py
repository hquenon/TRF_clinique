...
sorciere_model_predictif_names = [
    'loudness',
    'brightness',
    'periodicity',
    'half_rectified_der_loudness',
...
sorciere_regs_acoustic, sorciere_regs_acoustic_label, sorciere_regs_predictive, sorciere_regs_predictive_labels = funcs.model_definition(
    sorciere_regs_all,
...
pianos_regs_acoustic, pianos_regs_acoustic_label, pianos_regs_predictive, pianos_regs_predictive_labels = funcs.model_definition(
    pianos_regs_all,
